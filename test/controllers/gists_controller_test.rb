...
class GistsControllerTest < ActionController::TestCase
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post :create, gist: { description: @gist.description, hubid: @gist.hubid, public: @gist.public, saved: @gist.saved, userlogin: @gist.userlogin }
    end
  ...
  test "should update gist" do
    patch :update, id: @gist, gist: { description: @gist.description, hubid: @gist.hubid, public: @gist.public, saved: @gist.saved, userlogin: @gist.userlogin }
    assert_redirected_to gist_path(assigns(:gist))
  end
