...
class FichiersControllerTest < ActionController::TestCase
  ...
  test "should create fichier" do
    assert_difference('Fichier.count') do
      post :create, fichier: { content: @fichier.content, filename: @fichier.filename, language: @fichier.language }
    end
  ...
  test "should update fichier" do
    patch :update, id: @fichier, fichier: { content: @fichier.content, filename: @fichier.filename, language: @fichier.language }
    assert_redirected_to fichier_path(assigns(:fichier))
  end
